...
public class BlockBreakEdit extends Subcommand implements HasParams, HasParentCommand {
    ...
    public boolean execute(Sender sender, String[] args) {
        ...
        DropBlockBreak blockBreak = (DropBlockBreak) LunaticDrops.getDrop(TriggerType.BLOCK_BREAK, blockName);

        Player p = Bukkit.getPlayer(player.getUniqueId());
        GUIManager.openGUI(new EditorGUIBlockBreak(blockBreak), p);
        return true;
    }
